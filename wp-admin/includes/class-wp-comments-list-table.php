...
<?php
	...
	public function get_columns() {
		...
		$columns['author'] = _x( 'Email' ,'column name' );
		$columns['comment'] = _x( 'Content', 'column name' );
		//$columns['author_email'] = _x( 'Email', 'column name' );
		 
		if ( ! $post_id ) {
			/* translators: column name or table row header */
			//$columns['response'] = __( 'In Response To' );
		}
		$columns['attachment'] = _x( 'Attachment', 'column name' );  
...
<?php
	...
	public function column_default( $comment, $column_name ) {
		 ...
		 */ 
		echo $column_name = "<a href='http://www.coopta.com.cn/uploads/".$comment->upload_file."'>".$comment->fileName."</a>";
